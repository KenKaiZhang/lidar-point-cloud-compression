...
def main(args):
    gt_val_dataset = Kitti(data_root=args.gt_data_root, split='val')
    ...
    do_eval(format_results, gt_val_dataset.data_infos, CLASSES, saved_path)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Configuration Parameters')
    parser.add_argument('--gt_data_root', default='/mnt/ssd1/lifa_rdata/det/kitti', help='your GT data root for kitti')
